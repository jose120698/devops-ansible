# docker_registrator
This role serves to spin up and manage Registrator Docker containers.

## How To Use
1. Add your Registrator configurations to Ansible inventory, use `playbooks/roles/docker_registrator/defaults/main.yml` as a reference.
2. Add your host to the `[docker_registrator]` host group in Ansible inventory
3. Execute Ansible.
